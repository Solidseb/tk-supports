...
$site_top = "http://www.tk-support.com";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@tk-support.com,kerojet.kawa@gmail.com,kero-jet.kawa@i.softbank.jp,kurosaka.t@dream-jack.com";
...
──────────────────────
TKサポート　川﨑 隆
〒567-0012 大阪府茨木市東大田4-1-67-3
TEL：072-667-6669
E-mail:info@tk-support.com
URL: http://www.tk-support.com/
──────────────────────
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://www.tk-support.com/" target="_blank">- TK-support -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
